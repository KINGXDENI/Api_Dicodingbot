    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Dicoding Bot - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6282144323683">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Dicoding Bot</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Dicoding Bot" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Dicoding Bot`,
        html: inboxGmail,
      };
